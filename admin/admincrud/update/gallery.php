...
<head>
    ...
    <link rel="stylesheet" href="http://use.fontawesome.com/releases/v5.13.0/css/v4-shims.css">
</head>
...
?>
    ...
    <h3 class="font-weight-light text-black-50 mt-4 mb-5">
        <center>Modifier la photo de la galerie photo</center>
    </h3>
            ...
            <div class="col-6">
                ...
                <label for="exampleFormControlSelect1">Catégorie</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="alt" required value="<?= $donnees['alt'];?>">
                    </div>
