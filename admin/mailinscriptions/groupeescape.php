...
foreach($_POST['groupe'] as $team => $value) {
    ...
    $equipes = $bdd->prepare("SELECT * FROM rdeescaperegister, rdeparticipants WHERE rdeescaperegister.name_team = '$team' AND rdeescaperegister.participant_id = rdeparticipants.id_participant");
    $equipes->execute();
...
header('location: ../inscriptions.php?success=11');
